...
In Java OutputFormatting,Java's System.out.printf function can be used to print formatted output. 
...
/*
format string - two parameters(eg: ("%d",num))
%[flags][precision][wwidth][conversion character]
precision is for decimal numbers(eg: 100.234 - %.2f => 100.23)
width - makes the length of the value to be specified width
conversion character - %d,%f,%b,%c,%s
flags - (left-justify(-),+,-,0,(,))
*/
